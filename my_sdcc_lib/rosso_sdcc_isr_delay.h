/* 
 * File:   sdcc_isr_delay.h
 * Author: sotea
 *
 * Created on May 9, 2016, 2:47 AM
 */

#ifndef SDCC_ISR_DELAY_H
#define	SDCC_ISR_DELAY_H


#ifndef TMR0_DELAY_SLOTS
#define TMR0_DELAY_SLOTS 0
#endif
...
#ifdef TMR0_SLOTED
void tmr0_set_delay(uint8_t slot, uint16_t ticks) {
